...
| `0003-ple-nvme-pread.patch` | Add safetensors-backed PLE row access (`mmap` or parallel `pread`), isolate the PLE subprocess from the PP partition, and load only small PLE metadata tensors. |
